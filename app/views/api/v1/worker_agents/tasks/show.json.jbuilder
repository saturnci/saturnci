...
json.project_name repository.name
json.docker_registry_cache_username ENV["DOCKER_REGISTRY_CACHE_USERNAME"]
json.docker_registry_cache_password ENV["DOCKER_REGISTRY_CACHE_PASSWORD"]
