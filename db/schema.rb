...
ActiveRecord::Schema[8.0].define(version: 2025_03_12_134722) do
  ...
  create_table "test_runner_statuses", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "test_runner_id", null: false
    t.integer "type", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["test_runner_id", "type"], name: "index_test_runner_statuses_on_test_runner_id_and_type", unique: true
    t.index ["test_runner_id"], name: "index_test_runner_statuses_on_test_runner_id"
  end
  ...
  add_foreign_key "test_runner_statuses", "test_runners"
